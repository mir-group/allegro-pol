...
MATERIAL_CONFIG = {
    "BaTiO3": {
        ...
        "p_unit": [[3.966084, 0, 0], [0, 3.966084, 0], [0, 0, 4.304025]],
    }
}
        ...
        for frame in range(self.nframes):
            for ia in range(self.nat):
                ...
                if (
                    ...
                    or r[1] < -δ
                    or r[2] < -δ
                    or r[0] > self.p[frame, 0, 0] + δ
                    or r[1] > self.p[frame, 1, 1] + δ
                    or r[2] > self.p[frame, 2, 2] + δ
                ):
        ...
        for frame in tqdm.trange(self.nframes):
            ...
            if save_pdf:
                ...
                for j in range(n_y + 1):
                    ax.axhline(y=j, color="black", linestyle="--", linewidth=0.5)
